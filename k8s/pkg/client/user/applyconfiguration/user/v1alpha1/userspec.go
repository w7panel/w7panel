...
// WithIsSuper sets the IsSuper field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the IsSuper field is set to the value of the last call.
func (b *UserSpecApplyConfiguration) WithIsSuper(value bool) *UserSpecApplyConfiguration {
	b.IsSuper = &value
	return b
}
...
func (b *UserSpecApplyConfiguration) WithNamespaces(values ...string) *UserSpecApplyConfiguration {
	for i := range values {
