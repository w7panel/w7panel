...
type UserInformer interface {
	...
	Lister() userv1alpha1.UserLister
}
...
func (f *userInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisuserv1alpha1.User{}, f.defaultInformer)
}

func (f *userInformer) Lister() userv1alpha1.UserLister {
	return userv1alpha1.NewUserLister(f.Informer().GetIndexer())
}
