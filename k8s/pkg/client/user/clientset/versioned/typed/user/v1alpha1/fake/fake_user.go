...
type fakeUsers struct {
	*gentype.FakeClientWithListAndApply[*v1alpha1.User, *v1alpha1.UserList, *userv1alpha1.UserApplyConfiguration]
	Fake *FakeUserV1alpha1
}

func newFakeUsers(fake *FakeUserV1alpha1, namespace string) typeduserv1alpha1.UserInterface {
	return &fakeUsers{
		gentype.NewFakeClientWithListAndApply[*v1alpha1.User, *v1alpha1.UserList, *userv1alpha1.UserApplyConfiguration](
			fake.Fake,
			namespace,
