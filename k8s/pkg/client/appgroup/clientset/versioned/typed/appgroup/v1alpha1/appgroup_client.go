...
import (
	...
	appgroupv1alpha1 "gitee.com/we7coreteam/k8s-offline/k8s/pkg/apis/appgroup/v1alpha1"
	scheme "gitee.com/we7coreteam/k8s-offline/k8s/pkg/client/appgroup/clientset/versioned/scheme"
...
// NewForConfigAndClient creates a new AppgroupV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AppgroupV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
...
func setConfigDefaults(config *rest.Config) error {
	gv := appgroupv1alpha1.SchemeGroupVersion
